...
Version  : 2.6
Release  : 20
URL      : https://github.com/scop/bash-completion/archive/2.6.tar.gz
Source0  : https://github.com/scop/bash-completion/archive/2.6.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1498585029
