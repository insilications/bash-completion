...
Version  : 2.11
Release  : 35
URL      : file:///aot/build/clearlinux/packages/bash-completion/bash-completion-v2.11.tar.gz
Source0  : file:///aot/build/clearlinux/packages/bash-completion/bash-completion-v2.11.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628715254
