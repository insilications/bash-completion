...
Source0  : https://github.com/scop/bash-completion/releases/download/2.10/bash-completion-2.10.tar.xz
Summary  : Programmable completion for the bash shell
Group    : Development/Tools
License  : GPL-2.0
Requires: bash-completion-data = %{version}-%{release}
Requires: bash-completion-license = %{version}-%{release}
...
%package license
Summary: license components for the bash-completion package.
Group: Default

%description license
license components for the bash-completion package.


%prep
%setup -q -n bash-completion-2.10
cd %{_builddir}/bash-completion-2.10
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580240227
export GCC_IGNORE_WERROR=1
export CFLAGS="$CFLAGS -fno-lto "
export FCFLAGS="$CFLAGS -fno-lto "
export FFLAGS="$CFLAGS -fno-lto "
export CXXFLAGS="$CXXFLAGS -fno-lto "
%reconfigure --disable-static --without-pytest
make  %{?_smp_mflags}
...
cp %{_builddir}/bash-completion-2.10/COPYING %{buildroot}/usr/share/package-licenses/bash-completion/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
%make_install
## Remove excluded files
rm -f %{buildroot}/usr/share/bash-completion/completions/cal
rm -f %{buildroot}/usr/share/bash-completion/completions/dmesg
rm -f %{buildroot}/usr/share/bash-completion/completions/eject
rm -f %{buildroot}/usr/share/bash-completion/completions/hexdump
rm -f %{buildroot}/usr/share/bash-completion/completions/hwclock
rm -f %{buildroot}/usr/share/bash-completion/completions/ionice
rm -f %{buildroot}/usr/share/bash-completion/completions/look
rm -f %{buildroot}/usr/share/bash-completion/completions/renice
rm -f %{buildroot}/usr/share/bash-completion/completions/rtcwake
rm -f %{buildroot}/usr/share/bash-completion/completions/su
rm -f %{buildroot}/usr/share/bash-completion/completions/mount
rm -f %{buildroot}/usr/share/bash-completion/completions/umount
...
/usr/share/package-licenses/bash-completion/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
