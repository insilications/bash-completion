...
Source0  : https://github.com/scop/bash-completion/releases/download/2.9/bash-completion-2.9.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1556386519
...
cp COPYING %{buildroot}/usr/share/package-licenses/bash-completion/COPYING
%make_install
...
/usr/share/package-licenses/bash-completion/COPYING
